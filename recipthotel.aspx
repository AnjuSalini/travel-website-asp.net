<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageuser.master" AutoEventWireup="true" CodeFile="recipthotel.aspx.cs" Inherits="recipthotel" %>
    ...
    <script>
      ...
      <div class="bfeed" style="background-color:white;">
          <table class="auto-style1">
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: x-large; color: #808080;">Receipt</td>
              </tr>
              <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
